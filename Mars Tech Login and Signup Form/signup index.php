...
<body>
  <div class="form-container">
    ...
    <div id="success-message" class="hidden">
      ...
      <p>Thank you for signing up. Your details have been submitted for approval. You can sign in once your account is activated.</p>
      <button onclick="resetToSignUp()">Back to Sign Up</button>
    </div>
